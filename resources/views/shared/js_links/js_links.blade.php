...
<script src="{{ asset('public/js/my_js/PlcEvidences.js?n=5') }}"></script>
<script src="{{ asset('public/js/my_js/JsoxPlcMatrix.js?n=3') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModules.js?n=2') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModulesFlowChart.js?n=6') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModulesRCM.js?n=7') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModuleSaData.js?n=7') }}"></script>
<script src="{{ asset('public/js/my_js/SelectPlcEvidence.js?n=2') }}"></script>

<script src="{{ asset('public/js/my_js/ClcCategory.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/ClcEvidences.js?n=3') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiClc.js?n=2') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiFcrp.js?n=2') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiItClc.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiItClc.js?n=1') }}"></script>
