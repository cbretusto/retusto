...
<!-- Custom JS -->
<script src="{{ asset('public/js/my_js/UserManagement.js?n=4') }}"></script>
<script src="{{ asset('public/js/my_js/UserLevel.js?n=1') }}"></script>

<script src="{{ asset('public/js/my_js/PlcCategory.js?n=4') }}"></script>
<script src="{{ asset('public/js/my_js/PlcEvidences.js?n=4') }}"></script>
<script src="{{ asset('public/js/my_js/JsoxPlcMatrix.js?n=2') }}"></script>
...
<script src="{{ asset('public/js/my_js/PlcModulesRCM.js?n=3') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModuleSaData.js?n=4') }}"></script>

<script src="{{ asset('public/js/my_js/ClcCategory.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/ClcEvidences.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiClc.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiFcrp.js?n=1') }}"></script>
