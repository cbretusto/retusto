<table>
    ...
    <tr>
        <td style="font-size: 10px"><?php echo e($data[0]->assessed_by); ?></td>
        <td style="font-size: 10px"><?php echo e($data[0]->checked_by); ?></td>
        <td style="font-size: 10px"><?php echo e($data[0]->second_half_assessed_by); ?></td>
        <td style="font-size: 10px"><?php echo e($data[0]->second_half_checked_by); ?></td>
    </tr>
