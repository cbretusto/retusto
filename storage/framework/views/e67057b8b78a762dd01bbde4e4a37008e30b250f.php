...
<?php $__env->startSection('content_page'); ?>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <input type="text" id="plc_categories" value="<?php echo Session::get('goto_id') ?>">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <input type="hidden" name="session_name" value="<?php echo e(Session::get('goto_id')); ?>">
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="SA-TabId" role="tabpanel" aria-labelledby="SA-tab" style="height: 666px; overflow-y: scroll;">
                                        ...
                                        <a href = 'export'><button class="btn btn-primary"><i class="fas fa-file-export"></i> Export Audit Result</button><br><br>
                                        </a>
            ...
            <div class="modal-content">
                ...
                <form method="post" id="formAddRevision" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="hidden" name="category_name" id="txtCategoryNameId"value="<?php echo e(Session::get('goto_id')); ?>">
                ...
                <form id="formNoRevision" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="category_name" id="txtCategoryNameId"
                            value="<?php echo e(Session::get('goto_id')); ?>">
                    </div>
                    <div class="modal-footer justify-content-between">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group col-sm-3 flex-column d-flex">
                                    <input type="hidden" name="category_name" id="txtCategoryNameId" value="<?php echo e(Session::get('goto_id')); ?>">
                                        ...
                                        <input type="hidden" name="plc_category_name" id="txtPlcCategoryName" value="<?php echo e($pmi_01); ?>">
                                </div>
                                ...
                                <div class="row justify-content-between text-left">
                                    ...
                                    <div>
                                        <input type="radio" id="txtEditSaNonKeyControl" name="edit_key_control"
                                            value="X">
                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <input type="file" class="" id="DicAttachment" name="dic_attachment" onchange="loadFile">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="file" class="" id="OecAttachment" name="oec_attachment">
                                ...
                                <div class="row justify-content-between text-left">
                                    ...
                                    <div class="form-group col-sm-6 flex-column d-flex">
                                        <label>Checked by:</label>
                                        <select class="form-control sel-user-management-SA select2bs4" id="txtEditSaCheckedBy" name="second_half_checked_by"></select>
                                    </div>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="file" class="" id="RfAttachment" name="rf_attachment">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="file" class="" id="FuAttachment" name="fu_attachment">
    ...
    <input type="hidden" class="form-control" name="get_category" id="txtGetCategory1" value="<?php echo e($pmi_01); ?>">
            ...
            <div class="modal-content modal-sm">
                ...
                <form method="post" id="formSelectPlcEvidences">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="category_id" id="txtCategoryId" value="<?php echo e(Session::get('goto_id')); ?>">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Jsox_testing/resources/views/PLC Dashboard/pmi-01.blade.php ENDPATH**/ ?>